...
const firebaseConfig = {
  apiKey: "AlzaSyC8ReuMtfKQSqAAAp0Me5j79Q0et3SsxI",
...
const appId = 'lifeline-blood-circle';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Updated Path to match direct collections
    ...
    // Updated Path for appConfig
    const statsDocRef = doc(db, 'appConfig', 'stats');
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // Updated Paths
      const statsRef = doc(db, 'appConfig', 'stats');
